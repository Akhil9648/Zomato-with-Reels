...
const UserRegister = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      console.log('UserRegister submit');

      const name = e.target.firstName.value; // backend expects a single "name"
      ...
      // Optional: display a user-friendly message based on err.response?.data?.message
    }
  };
